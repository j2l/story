...
squiffy.story.id = 'cde7f020fc';
squiffy.story.sections = {
	'_default': {
		'text': "<p>Squiffy is a tool for creating interactive stories.</p>\n<p>You write your story in a text file. Each choice is represented by a <a class=\"squiffy-link link-section\" data-section=\"new section\" role=\"link\" tabindex=\"0\">new section</a>. You can create links to new sections by surrounding them in double square brackets.\n<b>Money = {money}</b></p>\n<p><span class=\"get-image-link\">Please supply a link to your image:\n</span></p>\n<input type=\"text\" id=\"user-img\">\n\n<p><span class=\"get-image-link\"><a class=\"squiffy-link link-section\" data-section=\"SUBMIT IMAGE\" role=\"link\" tabindex=\"0\">SUBMIT IMAGE</a></span></p>",
		'attributes': ["money = 1000","life = 1","money +=1"],
		'passages': {
		},
	},
	'SUBMIT IMAGE': {
		'text': "<p>{userImg}</p>\n<p><img src=\"http://i.imgur.com/rB3e4uK.jpg\" alt=\"Civ\" style=\"width: 100%;height: auto;\"><br></p>",
		'js': function() {
